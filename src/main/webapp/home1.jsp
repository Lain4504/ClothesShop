											...
											<div class="mega_menu">
												<ul class="mega_menu_inner">
													...
													<c:forEach items="${requestScope.category}" var="c">
														<li style="color: black; font-size: 16px"><a
															href="refine?cid_refine=${c.id}">${c.name}</a></li>
													</c:forEach>
												</ul>
											</div></li>
						...
						<div class="product_tab_btn">
							<ul class="nav" role="tablist">
								<li><a href="home1?cid=${0}" class="${chid[0]==true?"active":""}">
										ALL </a></li>
								<c:forEach items="${requestScope.category}" var="c">
									<li value="${c.id}"><a href="home1?cidYear=${c.id}"
										class="${c.id==cidYear?"active":""}"> ${c.name} </a></li>
								</c:forEach>
							</ul>
						</div>
					</div>
										...
										<figure>
											<div class="product_thumb">
												<a href="#" class="primary_img"> <img
													src="${p.image[0]}" alt="">
												</a> <a href="#" class="secondary_img" height="270px"> <img
													src="${p.image[1]}" alt="">
												</a>
										...
										<article class="single_product">
											<figure>
													...
													<div class="action_links">
														<ul>
															...
															<li class="wishlist"><a href="#"
																...
																title="Add to Wishlist"> <i style="color: #f6692a"
												...
												<figcaption class="product_content">
													...
													<div class="price_box">
														<span class="old_price">Rs.${hotDeal.price} </span> <span
														...
														<div class="action_links">
															<ul>
																<li class="add_to_cart"
																	...
																	data-target="#modal_box" title="Add to Cart"> <i
